...
<div class="container mx-auto p-8">
    ...
    <div class="mt-4">
        <p class="text-xl font-bold">Total Items: <%= cartData.size() %></p>
        <p class="text-xl font-bold">Total Amount: $<%= cartData.entrySet().stream().mapToDouble(entry -> entry.getKey().getPrice() * entry.getValue()).sum() %></p>

        <!-- Thêm form để gửi yêu cầu thanh toán -->
